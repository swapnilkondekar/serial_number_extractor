...
class SerialNumberExtractor {
  ...
  List<String> extractAllSerialNumbers(String ocrText) {
    ...
    final commaSeparatedPattern = r'\b([A-Z0-9]{6,12}(?:[,]\s*[A-Z0-9]{6,12})+)\b';
    ...
    for (final pattern in _customPatterns) {
      // Skip the comma-separated pattern as we already handled it
